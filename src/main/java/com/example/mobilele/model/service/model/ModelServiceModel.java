package com.example.mobilele.model.service.model;

import com.example.mobilele.model.view.offer.OfferViewModelWithIdAndUrl;
...
public class ModelServiceModel {
    ...
    public ModelServiceModel setCategory(VehicleCategoryEnum category) {
